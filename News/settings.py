...
SECRET_KEY = '&261rgf5c=xr=%_j0u#a2^tx@iq&!z9w5l-yl70=x8c#6-8c32'
...
INSTALLED_APPS = [
    ...
    'apps.sign',
    'apps.protect.apps.ProtectConfig',
    'apps.users',
...
MIDDLEWARE = [
    ...
    'apps.news.middlewares.TimezoneMiddleware',
    #
]
SITE_ID = 1
...
EMAIL_HOST_PASSWORD = 'yety.2000.alex' # пароль от почты
