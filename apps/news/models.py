...
class Post(models.Model):
    ...
    categories = models.ManyToManyField(Category,through='PostCategory', verbose_name= _('Tag'), related_name = 'categories', help_text= _('tag'))
...
class Comment(models.Model):
    ...
    com_text = models.TextField(verbose_name=_('Text'), help_text=_('comment'))
